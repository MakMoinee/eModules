...
<body>
    ...
    <header class="header-area header-sticky">
        <img style="float: left;padding: 10px;margin-left: 50px;" src="/storage/images/favicon.ico" alt="" srcset="" width="80px"
            height="80px" class="img-responsive">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"
                        ...
                        <img src="images/slider-icon.png" class="rounded img-fluid d-block mx-auto"
        ...
        <div class="container">
            <div class="row">
                <div class="owl-carousel owl-theme">
                    ...
                    <div class="item service-item">
                        <div class="icon">
                            <i><img src="images/service-icon-02.png" alt=""></i>
                        </div>
